 ...
 * @author     singh1469
 */
class Buto_Addvideo_Block_Adminhtml_Widget_Chooser extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    public function __construct($arguments = array())
    {
        ...
        try {
            ...
            $collection = Mage::getModel('addvideo/video')->getAll($organisation_id, $api_key, $cache_lifetime);
